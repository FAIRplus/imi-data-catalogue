...
class ImportEntitiesConnector(EntitiesConnector, metaclass=ABCMeta):
    """
    Abstract class specifying the methods that must be implemented by all ImportEntitiesConnector:
        - build_all_entities
